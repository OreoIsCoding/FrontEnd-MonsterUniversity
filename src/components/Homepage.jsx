...
<section className="relative h-screen bg-blue-950">
  <img
    ...
    className=" hide-bg-image w-full h-full object-contain object-right px-[70px] " 
  />

  <div className="absolute inset-0 z-50 sm:col-auto">
    <h1
      className="text-4xl sm:welcome-text md:welcome-text lg:text-7xl justify-start text-center ml-[45px] mt-[120px] font-bold text-white w-1 opacity-0 scroll-animate"
      style={{
    ...
    <div className="flex flex-auto justify-start">
      <div className="text-[18px] text-white px-10 py-10">
        <button
          ...
          className="button-glowing bg-[#448FA3] text-white p-2 rounded-[15px] hover:bg-[#00c8ff66] focus:outline-none "
        >
          Enroll now!
        </button>
      </div>
...
<section className="min-h-screen flex justify-center items-center bg-gray-800">
  <div className="text-center">
    <h2 className="text-3xl sm:text-4xl font-semibold mb-6 text-gray-300 scroll-animate">
      Our Features
    </h2>
    <div className="flex xs:flex-col sm:flex-col justify-center md:flex-row lg:flex-row xl:flex-row gap-8 xs:gap-10 sm:gap-10 md:gap-12">
      {/* Explore Feature */}
      <div className="bg-gray-200 text-gray-900 p-6 rounded-lg shadow-md w-full xs:w-full sm:w-96 md:w-80 lg:w-80 xl:w-80 transition-all transform hover:scale-105 hover:shadow-xl scroll-animate">
